...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/01 03:08:31 by jgim              #+#    #+#             */
/*   Updated: 2022/02/01 03:08:33 by jgim             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap()
{
	...
	_energy_points = FEP;
	_attack_damage = FAD;
	std::cout << "FragTrap 생성자를 호출하였습니다." << std::endl;
}
...
{
	*this = frag_trap;
	std::cout << "FragTrap 복사생성자를 호출하였습니다." << std::endl;
}

FragTrap::~FragTrap(){
	std::cout << "FragTrap 소멸자를 호출하였습니다." << std::endl;
}
...
FragTrap& FragTrap::operator=(const FragTrap & frag_trap) {
	...
	std::cout << "FragTrap 대입 연산자를호출하였습니다." << _name << ") called" << std::endl;
	return *this;
}
