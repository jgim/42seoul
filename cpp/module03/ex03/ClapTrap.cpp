...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/01 03:08:10 by jgim              #+#    #+#             */
/*   Updated: 2022/02/01 03:08:11 by jgim             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap():
		...
		_attack_damage(CAD)
{
	std::cout << "ClapTrap 생성자를 호출하였습니다." << std::endl;
}
...
{
	*this = clap_trap;
	std::cout << "ClapTrap 복사생성자를 호출하였습니다." << std::endl;
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		if (_hit_points + amount >= CHP)
		{
			_hit_points = CHP;
			std::cout << "ClapTrap " << _name << "은 체력이 " << CHP << "으로 완전히 회복되었습니다."<< std::endl;
		}
		else
		{
			_hit_points += amount;
...
ClapTrap &	ClapTrap::operator=(ClapTrap const & clap_trap)
{
	...
	std::cout << "ClapTrap 대입 연산자를 호출하였습니다." << std::endl;
	return (*this);
}

ClapTrap::~ClapTrap(){
	std::cout << "ClapTrap 소멸자를 호출하였습니다." << std::endl;
}
