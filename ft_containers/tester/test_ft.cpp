...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/29 17:55:21 by jgim              #+#    #+#             */
/*   Updated: 2022/05/29 17:55:22 by jgim             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_vector(const ft::vector<std::string>& v) {
...
void ft_vector_test() {
	...
	ft::vector<std::string> vector2(vector1.begin(), vector1.end());
	std::cout << "vector2: ";
	...
	ft::vector<std::string>::iterator it = vector3.begin();
	...
	ft::vector<std::string>::reverse_iterator rvrIt = vector3.rbegin();
...
void print_map(const ft::map<std::string, int>& m) {
...
void ft_map_test() {
	...
	ft::map<std::string, int> map2(map1.find("42"), map1.end());
	std::cout << "map2 : ";
	print_map(map2);
	...
	ft::map<std::string, int>::reverse_iterator rvrIt = map3.rbegin();
	...
	for (int i = 0, j = 100; i < 300000; i++, j++) {
		map4.insert(ft::make_pair(i * 2, j));
	}
