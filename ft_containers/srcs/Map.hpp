...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/29 17:54:27 by jgim              #+#    #+#             */
/*   Updated: 2022/05/29 17:54:29 by jgim             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**/
		...
		public:
			...
			map(const map &x) : _compare(x._compare), _allocator(x._allocator), _size(0), _root(0)
			{
				_setup();
				*this = x;
			}
...
**/
			...
			{
				node	*new_node = this->_allocator.allocate(1);
				this->_allocator.construct(new_node, val);
				new_node->begin = &this->_begin;
				new_node->end = &this->_end;
